...
grant select on public.v_fixture_motm to web_reader;
...
grant select on public.v_player_motm_awards to web_reader;
...
grant select on public.v_rating_events_public to web_reader;
...
grant select on public.v_season_table to web_reader;
...
grant select on public.v_career_table to web_reader;
